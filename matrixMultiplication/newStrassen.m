...
function C = newStrassen( A, B )
    ...
    if (sizeN == 1)
        ...
        % Compute M1, M2, ... M7
        M1 = newStrassen(A11 + A22, B11 + B22);
        M2 = newStrassen(A21 + A22, B11);
        M3 = newStrassen(A11, B12 - B22);
        M4 = newStrassen(A22, B21 - B11);
        M5 = newStrassen(A11 + A12, B22);
        M6 = newStrassen(A21 - A11, B11 + B12);
        M7 = newStrassen(A12 - A22, B21 + B22);
